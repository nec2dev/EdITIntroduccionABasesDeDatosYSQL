...
#<-------------Etapa 2.2.1------------->
/*1. Abrir el archivo con formato SQL con el nombre  NACIMIENTOS* desde MySQL Workbench. 
(Este archivo lo encontrarás disponible en el área  de Descargas del presente módulo).
2. Ejecutar el código.
3. Actualizar los esquemas para corroborar la generación de la tabla NACIMIENTOS dentro 
...
DESC nacimientos;
SELECT * FROM nacimientos;
SELECT * FROM nacimientos WHERE nacionalidad <> 'Chilena' AND nacionalidad <> 'Nacionalizada';
